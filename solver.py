...
class Solver(object):
    ...
    def print_state_and_score(self, direction):
        if direction == 0:
            for row in self.state:
                for cell in row:
                    if cell < 0:
...
def call():
    ...
    solver.print_state_and_score(0)
    print("")
    solver.print_state_and_score(1)
    print("")
    solver.print_state_and_score(2)
    print("")
    solver.print_state_and_score(3)
